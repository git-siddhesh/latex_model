...
def main():
    ...
    model.to(0)
    print("Original Model type:",model.dtype)
    # input("Model loaded: Enter to continue ...")
    ##################################################################################################
    ...
    print("_____________________ GPU Usage after tokenizing the data; before training  ________________________________________")
    gpu_usage()
